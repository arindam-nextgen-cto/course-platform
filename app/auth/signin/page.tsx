      ...
      <div className="text-center">
        <p className="text-muted-foreground text-sm">
          ...
          <Button asChild variant="link">
            <Link href="/auth/signup" className="font-medium text-[hsl(var(--accent-2))] hover:opacity-90">Create an account</Link>
          </Button>
        </p>

        <p className="text-xs text-muted-foreground mt-3">By signing in you agree to our <Link href="/terms" className="text-[hsl(var(--accent-2))]">Terms</Link> and <Link href="/privacy" className="text-[hsl(var(--accent-2))]">Privacy</Link>.</p>
      </div>
    </div>
  )
}